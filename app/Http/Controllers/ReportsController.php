...
class ReportsController extends Controller
{
    ...
    public function allProjectsToolsInventory(Request $request,$id = 0){
        ...
        $project = new Project();
        $projects = $project->getAllProjects();
        $data = $project->allProjectsToolsInventory($project_id);

        return view('reports/allProjectsToolsInventory')->with('data',$data)->with('projects',$projects);
    }
    ...
    public function returnedItemsReports(Request $request){
        ...
        $report = new Reports();
        $data = $report->getReturnedItemsReport($project_id);

        return view('reports.returnedItemsReports',compact('data','projects'));
    }

    public function returnedToolsReports(Request $request){
        ...
        $report = new Reports();
        $data = $report->getReturnedToolsReports($project_id);

        return view('reports.returnedToolsReports',compact('data','projects'));
    }
