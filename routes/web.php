...
Route::get('requestedGoods/markToolAsGood/{id}', 'RequestedGoodsController@markToolAsGood');
...
Route::get('reports/allProjectsToolsInventory/{id?}', 'ReportsController@allProjectsToolsInventory');
...
Route::get('reports/returnedItemsReports', 'ReportsController@returnedItemsReports');
Route::get('reports/returnedToolsReports', 'ReportsController@returnedToolsReports');
