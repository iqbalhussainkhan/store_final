...
//         html:
//         "<br>" +
//         '<button type="button" role="button" id="btn_good" tabindex="0" class="btn btn-success notika-btn-success col-md-3" style="margin-left: 25px;">' + 'Good' + '</button>' +
//         '<button type="button" role="button" id="btn_repair" tabindex="0" class="btn btn-warning notika-btn-warning  col-md-4 " style="margin-left: 15px;">' + 'Need Maintenance' + '</button>' +
//         '<button type="button" role="button" id="btn_demaged" tabindex="0" class="btn btn-danger notika-btn-danger  col-md-3" style="margin-left: 15px;">' + 'Damaged' + '</button><br>',
...
function returnedItemToStore(id,item_id) {
    ...
    if(condition == ''){
        error = 1;
        title = 'Please Add Tool Condition';
    }
    if(carton_no == ''){
        error = 1;
        title = 'Please Provide Carton number';
