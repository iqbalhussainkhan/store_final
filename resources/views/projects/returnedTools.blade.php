                                        ...
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <select  class="form-control"  style="font-weight: bold;" id="condition{{$val->id}}" name="condition">
                                                        <option value="">Select Condition</option>
                                                        <option value="0" class="text-success ">Good</option>
                                                        <option value="1" class="text-warning">Need Maintanence</option>
                                                        <option value="2" class="text-danger">Bad</option>
                                                    </select>
