                    ...
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="{{asset('reports/allProjectsInventory')}}"><h2>Materials</h2></a></li>
                                <li><a href="{{asset('reports/allProjectsToolsInventory')}}"><h2>Assets/Tools</h2></a></li>
                            </ul>
                        </div>
